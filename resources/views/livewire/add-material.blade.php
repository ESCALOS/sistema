    ...
    <x-jet-dialog-modal maxWidth="sm" wire:model="open_material">
        ...
        <x-slot name="content">
            <div class="py-2" style="padding-left: 1rem; padding-right:1rem">
                ...
                <select class="form-select text-center" style="width: 100%" wire:model='material_for_add'>
            ...
            <div class="flex px-4">
                ...
                <input class="text-center border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-l-md shadow-sm" type="number" min="0" style="height:30px;width: 100%" wire:model="quantity_material_for_add"/>
