<div>
    ...
    <x-jet-dialog-modal maxWidth="sm" wire:model="open_tool">
        ...
        <x-slot name="content">
                <div class="py-2" style="padding-left: 1rem; padding-right:1rem">
                    ...
                    <select class="select2 text-center" id="tool_for_add" style="width: 100%" wire:model='tool_for_add'>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex px-4">
                        ...
                        <input class="text-center border-gray-300 bg-red-600 text-white font-bold text-lg focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-l-md shadow-sm" type="number" min="0" style="height:30px;width: 100%" wire:model="quantity_tool_for_add"/>
    ...
    <script>
         $('#tool_for_add').on('change', function() {
            @this.set('tool_for_add', this.value);
        });
    </script>
</div>
