    ...
    <x-jet-dialog-modal maxWidth="sm" wire:model="open_componente">
        ...
        <x-slot name="content">
            ...
            <div class="py-2" style="padding-left: 1rem; padding-right:1rem;">
                ...
                <x-jet-input type="number" min="0" max="{{$stock_component_for_add}}" class="text-center" style="height:30px;width: 100%" wire:model="quantity_component_for_add" />
            ...
            <div class="py-2" style="padding-left: 1rem; padding-right:1rem;">
                ...
                <x-jet-input type="number" min="0" readonly class="text-center" style="height:30px;width: 100%" wire:model="stock_component_for_add" />

                <x-jet-input-error for="stock_component_for_add"/>
