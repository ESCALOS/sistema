<nav x-data="{ open:false }" class="bg-gray-800">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:block sm:ml-6">
          <div class="flex space-x-4">
            ...
            <a href="{{ route('operator.pre-reserva') }}" class="{{ request()->routeIs('operator.pre-reserva') ?  'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}} px-3 py-2 rounded-md text-sm font-medium">Pre-Reserva</a>
            ...
            <a href="{{ route('planner.insert-materials') }}" class="{{ request()->routeIs('planner.insert-materials') ?  'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}} px-3 py-2 rounded-md text-sm font-medium">Insertar Materiales</a>
  ...
  <div class="sm:hidden" x-show="open">
    <div class="px-2 pt-2 pb-3 space-y-1">
      ...
      @role('admin')
      <a href="#" class="{{ request()->routeIs('admin') ? 'bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page"' : 'text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium'}}">Dashboard</a>
      @endrole
