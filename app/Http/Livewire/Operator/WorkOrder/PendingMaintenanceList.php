...
namespace App\Http\Livewire\Operator\WorkOrder;
...
class PendingMaintenanceList extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.operator.work-order.pending-maintenance-list',compact('fechas','implementos','tareas','materiales'));
    }
}
