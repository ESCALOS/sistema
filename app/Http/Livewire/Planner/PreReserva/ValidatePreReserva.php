...
namespace App\Http\Livewire\Planner\PreReserva;
...
class ValidatePreReserva extends Component
{
    ...
    /*------------RENDERIZAR VISTA------------------------------------------------------------------------*/
        public function render()
        {
            ...
            return view('livewire.planner.pre-reserva.validate-pre-reserva',compact('sedes','locations','users','implements','pre_stockpile_detail_operator','pre_stockpile_detail_planner','pre_stockpile_detail_rechazado'));
        }
}
