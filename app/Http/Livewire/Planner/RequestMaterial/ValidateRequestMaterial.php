...
namespace App\Http\Livewire\Planner\RequestMaterial;
...
/*----------------------RENDER--------------------------------------------*/
    ...
    /*-------------------------------RENDERIZAR LA VISTA--------------------------------------------------------------*/
        return view('livewire.planner.request-material.validate-request-material', compact('sedes', 'locations','users','implements','order_request_detail_operator','order_request_detail_planner','order_request_detail_rechazado','order_request_new_materials','measurement_units'));
    /*---------------------------------------------------------------------------------------------------*/
    }
}
