...
--
-- Servidor: localhost
-- Tiempo de generación: 10-08-2022 a las 19:22:10
        ...
        IF(fecha_abrir_pre_reserva <= NOW()) THEN
            BEGIN
                ...
                /*-----------VARIABLES PARA MATERIAL-----------------------*/
                    DECLARE material INT;
                /*-----------CURSOR PARA ITERAR CADA IMPLEMENTO-----------------------------*/
                    DECLARE cursor_implementos CURSOR FOR SELECT id,implement_model_id,user_id,ceco_id FROM implements;
                    DECLARE CONTINUE HANDLER for NOT FOUND SET implemento_final = 1;
                /*-----------ABRIR CURSOR DE LOS IMPLEMENTOS--------------------------------*/
                    OPEN cursor_implementos;
                        bucle_implementos:LOOP
                            /*---------DETENER EL CICLO CUANDO NO ENCUENTRE MÁS IMPLEMENTOS-------------*/
                                ...
                                END IF;
                            /*---------OBTENER LOS DATOS DEL IMPLEMENTO DEL CICLO-----------------------*/
                                FETCH cursor_implementos INTO implemento,modelo_del_implemento,responsable,ceco;
                            /*---------HACER EN CASO LA PRE-RESERVA SI NO ESTÁ CREADA AÚN---------------*/
                                IF NOT EXISTS(SELECT * FROM pre_stockpiles WHERE implement_id = implemento AND state = "PENDIENTE" AND pre_stockpile_date_id = fecha_pre_reserva) THEN
                                    /*----------------------CREAR CABECERA DE LA PRE-RESERVA---------------------------------*/
                                        INSERT INTO pre_stockpiles (user_id,implement_id,ceco_id,pre_stockpile_date_id) VALUES (responsable,implemento,ceco,fecha_pre_reserva);
...
(43, 52, '19.00', '0.00', '150.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 17:32:51'),
(44, 44, '34.00', '0.00', '45.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 10:12:11'),
(45, 21, '17.00', '0.00', '50.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 10:12:11'),
(46, 9, '34.00', '0.00', '27.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 17:31:48'),
(47, 1, '2.00', '0.00', '450.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 10:12:11'),
(48, 57, '98.00', '0.00', '35.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 17:32:51'),
(49, 24, '13.00', '0.00', '130.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 17:32:51'),
(50, 3, '24.00', '1.00', '65.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 17:32:51'),
(51, 51, '1.00', '1.00', '200.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 18:28:20'),
(52, 7, '1.00', '0.00', '500.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 17:31:48'),
(53, 65, '1.00', '0.00', '260.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 10:12:11'),
(54, 5, '2.00', '1.00', '45.00', 1, 1, '2022-07-26 14:45:52', '2022-07-29 18:28:15'),
(55, 5, '1.00', '0.00', '45.00', 2, 1, '2022-07-26 14:45:56', '2022-07-29 10:12:11'),
(56, 9, '24.00', '0.00', '27.00', 2, 1, '2022-07-26 14:45:56', '2022-07-29 17:31:48'),
(57, 52, '40.00', '1.00', '150.00', 2, 1, '2022-07-26 14:45:56', '2022-07-29 17:32:51'),
(58, 57, '33.00', '0.00', '35.00', 2, 1, '2022-07-26 14:45:56', '2022-07-29 17:32:51'),
(59, 42, '1.00', '0.00', '75.00', 2, 1, '2022-07-26 14:45:56', '2022-07-29 17:31:48'),
(60, 4, '11.00', '0.00', '45.00', 2, 1, '2022-07-26 14:45:56', '2022-07-29 17:32:51'),
(61, 44, '40.00', '0.00', '45.00', 2, 1, '2022-07-26 14:45:56', '2022-07-29 10:12:11'),
(62, 3, '48.00', '0.00', '65.00', 2, 1, '2022-07-26 14:45:56', '2022-07-29 10:12:11'),
(63, 24, '27.00', '0.00', '130.00', 2, 1, '2022-07-26 14:45:56', '2022-07-29 17:32:51');
...
INSERT INTO `pre_stockpiles` (`id`, `user_id`, `implement_id`, `state`, `validated_by`, `ceco_id`, `pre_stockpile_date_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'PENDIENTE', NULL, 1, 1, '2022-08-10 18:43:53', '2022-08-10 18:43:53'),
(2, 2, 2, 'PENDIENTE', NULL, 2, 1, '2022-08-10 18:47:27', '2022-08-10 18:47:27'),
(3, 3, 3, 'PENDIENTE', NULL, 3, 1, '2022-08-10 18:53:15', '2022-08-10 18:53:15'),
(4, 4, 4, 'PENDIENTE', NULL, 4, 1, '2022-08-10 19:12:02', '2022-08-10 19:12:02'),
(5, 5, 5, 'PENDIENTE', NULL, 5, 1, '2022-08-10 19:14:42', '2022-08-10 19:14:42'),
(6, 6, 6, 'PENDIENTE', NULL, 6, 1, '2022-08-10 19:19:20', '2022-08-10 19:19:20');
...
('LAthuh05JZuxRgZ0HFRHuHO7ZZLldz42S913RQp1', NULL, '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64; rv:103.0) Gecko/20100101 Firefox/103.0', '', 1660139263),
('YL4LueQ7q60CR15kBa9rQVdTZFy4jZyGIX4vyfSn', 5, '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64; rv:103.0) Gecko/20100101 Firefox/103.0', '', 1660145282);
...
(23, 36, 3, 7, 7, '2022-08-11', 'MAÑANA', 7, 0, '2022-08-10 20:05:18', '2022-08-10 20:05:18'),
(24, 7, 3, 8, 8, '2022-08-11', 'MAÑANA', 7, 0, '2022-08-10 20:05:26', '2022-08-10 20:05:26');
...
(1, '777269', 'Mr. Ford Vandervort', 'Kunze', 1, 'roob.brianne@example.org', '2022-06-20 21:21:37', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, NULL, NULL, 0, '2noe1vOCyXt3GuOXrx8K2ucYaplPAnjaQqdNvq5Hl2uOuvGBhxY0NWi1UADO', NULL, NULL, '2022-06-20 21:21:37', '2022-06-20 21:21:37'),
